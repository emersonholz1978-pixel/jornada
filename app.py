...
def ensure_schema():
    ...
    try:
        ...
        question_groups = {ethics: question_rows, civil: civil_questions, constitutional: constitutional_questions, process_civil: process_civil_questions, penal: penal_questions, administrative: administrative_questions, labour: labour_questions, tax: tax_questions, business: business_questions}
